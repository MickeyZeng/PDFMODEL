...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/modelement/sysModelement/create">新建模版元素</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="sysModelement" action="${ctx}/modelement/sysModelement/save" method="post" class="form-horizontal">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="modelement:sysModelement:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="申 请"/>&nbsp;</shiro:hasPermission>
