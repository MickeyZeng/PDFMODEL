...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/sysmod/modTimes/check">设计模版次数审核列表</a></li>
</ul>
<form:form id="searchForm" modelAttribute="modTimes" action="${ctx}/sysmod/modTimes/check" method="post" class="breadcrumb form-search">
    ...
    <c:forEach items="${page.list}" var="modTimes">
        <tr>
            ...
            <shiro:hasPermission name="sysmod:modTimes:edit"><td>
                <a href="${ctx}/sysmod/modTimes/checkForm?id=${modTimes.id}">修改</a>
                <a href="${ctx}/sysmod/modTimes/checkPass?id=${modTimes.id}">通过</a>
                <a href="${ctx}/sysmod/modTimes/delete?id=${modTimes.id}" onclick="return confirmx('确认要删除该设计模版次数吗？', this.href)">不通过</a>
